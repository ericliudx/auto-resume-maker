...
- The canonical prompt instructs the model to **read every bank bullet** for each selected id and **summarize/rephrase** into exactly those patch counts—not to echo the first N bio lines unchanged.
